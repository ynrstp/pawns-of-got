...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function (_Component) {
	  ...
	  function App(props) {
	    ...
	    _this.filterName = _this.filterName.bind(_this);
	    _this.state = {
	      data: [
	        //   {_id: 1,
	        //     name: "Jon Snow",
	  ...
	  _createClass(App, [{
	    key: 'filterName',
	    value: function filterName(event) {
	    ...
	    value: function componentWillMount() {
	      ...
	      _superagent2.default.get('http://api.pawnsofgot.com/pawn').end(function (error, response) {
	        if (!error && response) {
	          var shuffledData = shuffle(response.body.data);
	          _this2.setState({ data: shuffledData, alldata: shuffledData });
	        } else {
	    ...
	    value: function render() {
	      ...
	      var items = this.state.data.map(function (item, i) {
	        return _react2.default.createElement(Item, { key: i, item: item });
	      });

	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement('input', { type: 'text', placeholder: 'Search', onChange: this.filterName }),
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'div',
	            { className: 'container', style: cardStyles },
	            _react2.default.createElement(
	              'div',
	              { className: 'card' },
	              _react2.default.createElement('div', { className: 'photo', style: photoStyles }),
	              _react2.default.createElement('div', { className: 'banner', style: bannerStyles }),
	              _react2.default.createElement(
	                'ul',
	                null,
	                _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'div',
	                { className: 'holder' },
	                _react2.default.createElement('div', { className: 'sigil', style: sigilStyles }),
	                _react2.default.createElement('div', { className: 'status', style: statusStyles })
	              )
	            )
	          )
	        )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var request = module.exports = __webpack_require__(174).bind(null, Request);
